...
export class RecipeBook {
  ...
  initPreview() {
    ...
    this.previewCamera = new THREE.PerspectiveCamera(35, 130 / 195, 0.1, 10);
    this.previewCamera.position.set(0, 0.31, 0.65);
    this.previewCamera.lookAt(0, 0.14, 0);
